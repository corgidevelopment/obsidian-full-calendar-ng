...
function stringifyYamlLine(k: string | number | symbol, v: PrintableAtom): string {
...
function modifyFrontmatterString(page: string, modifications: Partial<OFCEvent>): string {
