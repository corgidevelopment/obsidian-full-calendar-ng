...
export class MockCache implements MetadataCache {
  ...
  getFirstLinkpathDest(_: string, __: string): TFile | null {
    throw new Error("Method not implemented.");
  }

  fileToLinktext(_: TFile, __: string, ___?: boolean | undefined): string {
    throw new Error("Method not implemented.");
  }
  ...
  on(_: unknown, __: unknown, ___?: unknown): import("obsidian").EventRef {
    throw new Error("Method not implemented.");
  }
