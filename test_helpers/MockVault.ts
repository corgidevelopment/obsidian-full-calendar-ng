import { type DataAdapter, type DataWriteOptions, type EventRef, TAbstractFile, TFile, TFolder, Vault } from "obsidian";
...
export class MockVault implements Vault {
  ...
  async delete(file: TAbstractFile, _?: boolean | undefined): Promise<void> {
    file.parent.children.remove(file);
  }

  trash(file: TAbstractFile, _: boolean): Promise<void> {
  ...
  on(_: unknown, __: unknown, ___?: unknown): EventRef {
    throw new Error("Method not implemented.");
  }

  off(_: string, __: (...data: any) => any): void {
    throw new Error("Method not implemented.");
  }

  offref(_: EventRef): void {
    throw new Error("Method not implemented.");
  }

  trigger(_: string, ...__: any[]): void {
    throw new Error("Method not implemented.");
  }

  tryTrigger(_: EventRef, __: any[]): void {
    throw new Error("Method not implemented.");
  }
  ...
  append(
    _: TFile,
    __: string,
    ___?: DataWriteOptions | undefined
  ): Promise<void> {
    throw new Error("Method not implemented.");
  }
  ...
  readBinary(_: TFile): Promise<ArrayBuffer> {
    throw new Error("Method not implemented.");
  }
  ...
  getResourcePath(_: TFile): string {
    throw new Error("Method not implemented.");
  }
}
